...
public class DBOutputWritable implements Writable, DBWritable {
	...
	// ResultSet and PreparedStatement are two standard types in RW - DB process
	// These two are built-in types in mapred - mysql interface.
	// Usually they need to be implemented manually
	// search for "PreparedStatement in java into mysql" for more.
